...
1. A contributor submits a new pull request using [Contributor Pull Request Checklist](https://github.com/brackets-cont/brackets/wiki/Pull-Request-Checklist) as a guide.
...
7. The reviewer starts the review immediately after assigning it to themselves and uses the [Pull Request Review Checklist](https://github.com/brackets-cont/brackets/wiki/Pull-Request-Review-Checklist) as a guide.
